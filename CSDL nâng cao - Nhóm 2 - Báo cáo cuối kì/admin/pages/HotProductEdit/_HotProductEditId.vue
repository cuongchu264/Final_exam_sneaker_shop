<template>
    <main>
        <div>
            ...
            <h3 class="text-center mt-4">" CHI TIẾT SẢN PHẨM HOT "</h3>
                <div class="container bg-white">
                    ...
                    <b-form-group
                        ...
                        <b-form-input
                        id="input-2"
                        v-model="hotproduct.productName"
                    ...
                    <b-form-group id="input-group-6" label="Mô tả:" label-for="input-6">
                        <b-form-textarea
                        id="input-6"
                        v-model="hotproduct.description"
                    ...
                    <b-button style="margin: auto; display:block;" type="submit" variant="success" disabled>Update</b-button>
                    </b-form>
            </div>
        </div>
    </main>
...
export default {
    ...
    async asyncData({ $axios,params}) {
        const hotproduct = await $axios.$get(`api/Products/${params.HotProductEditId}`)
        return { hotproduct }
    },
    data(){
        return{
