                        ...
                        <table class="table mt-4">
                            ...
                            <tbody >
                                <tr v-for="(cate,index) in filteredCate" :key="index">
                                    ...
                                    <td>{{ cate.avatar }}</td>
                                    <td><a v-if="cate.categoryId != 1 && cate.categoryId != 2 && cate.categoryId != 3 && cate.categoryId != 4" type="button" class="btn btn-success" :href="getCategoriesEditurl(cate.categoryId)">Edit</a></td>
                                    <td><button v-if="cate.categoryId != 1 && cate.categoryId != 2 && cate.categoryId != 3 && cate.categoryId != 4" class="btn btn-danger" @click="DeleteCategories(cate.categoryId)" >Delete</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                        ...
                                        <table class="table mt-4">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Tên sản phẩm</th>
                                                    <th scope="col" class="text-center">Giá tiền($)</th>
                                                    <th scope="col" class="text-center">Số lượng bán ra</th>
                                                </tr>
                                            </thead>
                                                <tbody >
                                                <tr v-for="(flagship,index) in filteredFlagship" :key="index">
                                                    <th scope="row">{{ flagship.productId }}</th>
                                                    <td>{{ flagship.productName }}</td>
                                                    <td class="text-center">{{ flagship.price }}</td>
                                                    <td class="text-center">{{ flagship.quantity }}</td>
                                                    <td><a type="button" class="btn btn-success" :href="getHotProductEditurl(flagship.productId)">Detail</a></td>
...
import catalogApi from '@/api/catalogApi'
  export default {
    ...
    computed:{
        ...
        filteredFlagship(){
            return this.listFlagShip.filter((flagship) =>{
                return flagship.productName.toLowerCase().match(this.search.toLowerCase())
            });
        },
        NikeOfCurrPage () {
