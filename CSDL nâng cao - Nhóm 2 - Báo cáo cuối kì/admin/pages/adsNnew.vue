                        ...
                        <table class="table mt-4">
                            ...
                            <tbody >
                                <tr v-for="(Carousel,index) in filteredCarousel" :key="index">
                                    ...
                                    <td>{{ Carousel.text }}</td>
                                    <td v-if="Carousel.branchID == 1">Đà Nẵng</td>
                    ...
                    <div class="container bg-white">
                        <b-form method="post"  class="mt-3" @submit.prevent="CreateCarousel">
                            ...
                            <b-form-group id="input-group-4" label="Link bài viết Carousel:" label-for="input-4">
                             ...
                             <b-form-group id="input-group-7" label="Chi Nhánh:" label-for="input-7">
                                <b-form-group
                                    id="input-7"
                                    v-model="branchID"
                                    required
                        ...
                        <table class="table mt-4">
                            ...
                            <tbody >
                                <tr v-for="(New,index) in NewOfCurrPage" :key="index">
                                    ...
                                    <td v-if="New.branchID == 1">Đà Nẵng</td>
                                    <td v-else>Sài Gòn</td>
                        ...
                        <table class="table mt-4">
                            ...
                            <tbody >
                                <tr v-for="(newCate,index) in filteredNewCate" :key="index">
                                    ...
                                    <td><a v-if="newCate.newCateId != 1 && newCate.newCateId != 2 && newCate.newCateId != 3 && newCate.newCateId != 4" type="button" class="btn btn-success" :href="getNewCategoryEditurl(newCate.newCateId)">Edit</a></td>
                                    <td><button v-if="newCate.newCateId != 1 && newCate.newCateId != 2 && newCate.newCateId != 3 && newCate.newCateId != 4" class="btn btn-danger" @click="DeleteNewCategories(newCate.newCateId)" >Delete</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
