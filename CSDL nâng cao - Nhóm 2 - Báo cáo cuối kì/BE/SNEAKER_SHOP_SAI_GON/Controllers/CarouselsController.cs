...
namespace SNEAKER_SHOP_SAI_GON.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CarouselsController : ControllerBase
    {
        private readonly SneakerShopSaiGonDbContext _context;

        public CarouselsController(SneakerShopSaiGonDbContext context)
        {
            _context = context;
        }
