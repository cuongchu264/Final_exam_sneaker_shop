...
namespace SNEAKER_SHOP.Controllers
{
    ...
    public class BranchesController : ControllerBase
    {
        ...
        public BranchesController(SneakerShopDbContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Branch
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Branch>>> GetBrand()
        {
        ...
        // GET: api/Branch/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Branch>> GetBrand(int id)
        {
