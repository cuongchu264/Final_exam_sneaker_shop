        ...
        <div class="container emp-profile">
            ...
            <form method="put" @submit.prevent="UpdateInfo(profile)">
                ...
                >
                    <b-form-select
                    id="input-6"
                    v-model="profile.branchId"
                    required
                    >
                        <option v-for="(branch, index) in listbranch" :key="index" :value="branch.branchID">
                            {{ branch.branchName }}
                        </option>
                    </b-form-select>
                </b-form-group>
...
export default {
    ...
    methods:{
        ...
        async UpdateInfo(profile) {
            ...
            await this.setBranch(profile.branchId)
        ...
        async getBranch(){
            try{
                const { data } = await catalogApi.getBranch(this.$axios)
                console.log(data)
