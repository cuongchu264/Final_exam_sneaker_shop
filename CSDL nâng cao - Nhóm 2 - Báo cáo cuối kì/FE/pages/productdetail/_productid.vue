        ...
        <div class="container mt-5" style="display:flex;">
                ...
                <div class="text-center">
                    ...
                    <b-form @submit.prevent="AddCart(product)">
                        ...
                        <div class="text-center mt-2" v-if="!username.username">
                            <p style="font-size: small;" v-if="product.branchID == 1"><i>Sản phẩm hiện đang có sẵn ở chi nhánh Đà Nẵng</i></p>
                            <p style="font-size: small;" v-if="product.branchID == 2"><i>Sản phẩm hiện đang có sẵn ở chi nhánh Sài Gòn</i></p>
                        </div>
                    </b-form>
                </div>    
        </div>
