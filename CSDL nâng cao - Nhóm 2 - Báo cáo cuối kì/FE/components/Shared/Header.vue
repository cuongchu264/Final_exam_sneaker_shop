<template>
    <div>
        <b-navbar toggleable="lg" type="light" variant="white">
            ...
            <b-navbar-brand href="#" style="font-size: 25px;"><nuxt-link style="text-decoration:none; color:black;" to="/home"><strong>SNEAKER SHOP</strong></nuxt-link></b-navbar-brand>
            ...
            <b-collapse id="nav-collapse"  is-nav>
                <b-navbar-nav class="navbar" >
                    ...
                    <b-nav-item href="#"><nuxt-link to="/contact" class="bv" style="text-decoration:none; color:black; font-weight: bold;">HỖ TRỢ</nuxt-link></b-nav-item>
                </b-navbar-nav>
                ...
                <b-navbar-nav class="ml-auto">                    
                    ...
                    <b-nav-item-dropdown v-if="UserName.username" right>
                        ...
                        <b-dropdown-header id="dropdown-header-1">Khách hàng</b-dropdown-header>
                        ...
                        <b-dropdown-header v-if="UserName.branch == 1" id="dropdown-header-2">Chi nhánh: Đà Nẵng</b-dropdown-header>
                        <b-dropdown-header v-if="UserName.branch == 2" id="dropdown-header-2">Chi nhánh: Sài Gòn</b-dropdown-header>
                        <div v-for="(user,index) in listuser" :key="index">
                            <b-dropdown-item :href="geturl(user.userId)"><svg data-v-41be6633="" viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="geo alt" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-geo-alt mx-auto b-icon bi"><g data-v-41be6633=""><path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z"></path><path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path></g></svg>Chỉnh sửa chi nhánh</b-dropdown-item>
                        </div>
                    </b-nav-item-dropdown>
